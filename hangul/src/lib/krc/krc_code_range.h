...
#define KRC_CODE_RANGE_HANGUL_CHOSEONG         4
#define KRC_CODE_RANGE_HANGUL_JUNGSEONG        5
#define KRC_CODE_RANGE_HANGUL_JONGSEONG        6
#define KRC_CODE_RANGE_HANGUL_JAEUM            7
#define KRC_CODE_RANGE_HANGUL_MOEUM            8
