#ifndef __krc_input_type_h__
#define __krc_input_type_h__
...
//typedef signed   short int krc_int16_t; // krc
//typedef unsigned short int krc_uint16_t; // krc

typedef signed   int       krc_int32_t;
typedef unsigned int       krc_uint32_t;

//typedef unsigned long long int krc_size_t; // krc
//typedef signed   long long int krc_ssize_t;

//===========================================================================
//typedef unsigned int krc_bool_t; // krc
